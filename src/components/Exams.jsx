...
const Exams = () => {
  ...
  return (
    <div className="flex flex-wrap gap-5">
      <div className="relative my-5 flex justify-between items-center p-10 w-[30vw] h-[15vh]  bg-slate-300 rounded-lg hover:shadow-lg hover:bg-blue-300 cursor-pointer transition duration-300 ease-in"
      ...
      >
        ...
        <div className="flex flex-col justify-left w-[60%]">
          ...
          <div className="text-md font-semibold text-left">
            <span className="mr-2">Time:</span>8:00am - 10:00pm
          </div>
      ...
      >
        ...
        <div className="w-[60%] flex flex-col justify-left">
          ...
          <div className="text-md font-semibold text-left">18th July, 2023</div>
          {/* <div>Exam duration</div> */}
        </div>
        <div className="absolute bottom-0 right-0 px-5 flex items-center bg-green-600 h-7 rounded-tl-lg rounded-br-lg -md hover:bg-green-800/90 hover:shadow-lg transition duration-200 ease-in font-bold text-sm text-white">
          Click to Start
      ...
      >
        ...
        <div className="w-[60%] flex flex-col justify-left">
          ...
          <div className="text-md font-semibold text-left">26th July, 2023</div>
          {/* <div>Exam duration</div> */}
        </div>
        <div className="absolute bottom-0 right-0 px-5 flex items-center bg-green-600 h-7 rounded-tl-lg rounded-br-lg -md hover:bg-green-800/90 hover:shadow-lg transition duration-200 ease-in font-bold text-sm text-white">
          Click to Start
